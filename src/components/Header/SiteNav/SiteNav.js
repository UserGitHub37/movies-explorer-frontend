    ...
    <>
      <nav className='site-nav'>
        <ul className='site-nav__links'>
          <li className='site-nav__item-link'><Link to='/' className='site-nav__link'>Главная</Link></li>
      ...
      <button className="account-btn"><img src={accBtnlogoPath} alt='Логотип кнопки' className='account-btn__logo'/>Аккаунт</button>
      <button className="burger-btn"><img src={burgerImgPath} alt='Логотип бургерного меню' className='burger-btn__logo'/></button>
    </>
  );
}
